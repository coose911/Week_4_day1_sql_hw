...
INSERT INTO movies (title, year, show_time) VALUES ('Avengers: Infinity War', 2019, '14:30');
SELECT * FROM movies
...
DELETE FROM movies WHERE title IN ('Black Panther', 'Guardians of the Galaxy', 'The Incredible Hulk', 'Guardians of the Galaxy 2');
SELECT * FROM movies;